                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">Voir mon profil</li>
                                        </ol>
                                    </div>
                                    <h4 class="page-title"><?php echo $row->doc_fname; ?> <?php echo $row->doc_lname; ?> : Profile</h4>
                                </div>
                            </div>
                        </div>
                        <!-- end page title -->
                            ...
                            <div class="col-lg-6 col-xl-6">
                                <div class="card-box text-center">
                                    ...
                                    <div class="text-centre mt-3">
                                        ...
                                        <p class="text-muted mb-2 font-13"><strong>Nom complet Médecin :</strong> <span class="ml-2"><?php echo $row->doc_fname; ?> <?php echo $row->doc_lname; ?></span></p>
                                        <p class="text-muted mb-2 font-13"><strong>Department Médecin :</strong> <span class="ml-2"><?php echo $row->doc_dept; ?></span></p>
                                        <p class="text-muted mb-2 font-13"><strong>Numéro Médecin :</strong> <span class="ml-2"><?php echo $row->doc_number; ?></span></p>
                                        <p class="text-muted mb-2 font-13"><strong>Email Médecin :</strong> <span class="ml-2"><?php echo $row->doc_email; ?></span></p>
