                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box">
                                ...
                                <h4 class="page-title">Details Du Patient</h4>
                            </div>
                        </div>
                    </div>
                    <!-- end page title -->
                                        ...
                                        <div class="col-12 text-sm-center form-inline">
                                            <div class="form-group mr-2" style="display:none">
                                                <select id="demo-foo-filter-status" class="custom-select custom-select-sm">
                                                    ...
                                                    <option value="Discharged">Sortant</option>
                                ...
                                <div class="table-responsive">
                                    <table id="demo-foo-filtering" class="table table-bordered toggle-circle mb-0" data-page-size="7">
                                        <thead>
                                            <tr>
                                                <th>#</th>
                                                <th data-toggle="true">Nom Patient</th>
                                                <th data-hide="phone">Numéro Patient</th>
                                                <th data-hide="phone">Addresse Patient</th>
                                                <th data-hide="phone">Téléphones Patient</th>
                                                <th data-hide="phone">Age Patient</th>
                                                <th data-hide="phone">Categorie Patient</th>
