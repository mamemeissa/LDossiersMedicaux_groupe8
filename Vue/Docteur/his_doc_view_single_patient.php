                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title"><?php echo $row->pat_fname; ?> <?php echo $row->pat_lname; ?> : Profile</h4>
                                </div>
                            </div>
                        </div>
                        <!-- end page title -->
                            ...
                            <div class="col-lg-4 col-xl-4">
                                <div class="card-box text-center">
                                    ...
                                    <div class="text-left mt-3">
                                        ...
                                        <p class="text-muted mb-2 font-13"><strong>Nom :</strong> <span class="ml-2"><?php echo $row->pat_fname; ?> <?php echo $row->pat_lname; ?></span></p>
                                        ...
                                        <hr>
                                        <p class="text-muted mb-2 font-13"><strong>Date D'enrégistrement :</strong> <span class="ml-2"><?php echo date("d/m/Y - h:m", strtotime($mysqlDateTime)); ?></span></p>
                                        <hr>
