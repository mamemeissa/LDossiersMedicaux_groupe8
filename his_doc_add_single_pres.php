                    ...
                    <div class="container-fluid">
                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">Ajouter Prescription</li>
                                        </ol>
                                    </div>
                                    <h4 class="page-title">Ajouter Prescription Patient</h4>
                                </div>
                            </div>
                        </div>
                        <!-- end page title -->
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="header-title">Données du patient</h4>
                                        <!--Add Patient Form-->
                                        <form method="post">
                                            <div class="form-row">

                                                <div class="form-group col-md-6">
                                                    <label for="inputEmail4" class="col-form-label">Nom Patient</label>
                                                ...
                                                <div class="form-group col-md-6">
                                                    <label for="inputPassword4" class="col-form-label">Age Patient</label>
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-4">
                                                    <label for="inputEmail4" class="col-form-label">Numéro Patient</label>
                                                ...
                                                <div class="form-group col-md-4">
                                                    <label for="inputPassword4" class="col-form-label">Addresse Patient</label>
                                                ...
                                                <div class="form-group col-md-4">
                                                    <label for="inputPassword4" class="col-form-label">Type Patient</label>
                                            ...
                                            <div class="form-group ">
                                                <label for="inputCity" class="col-form-label">Maladie Patient</label>
                                            ...
                                            <button type="submit" name="add_patient_presc" class="ladda-button btn btn-primary" data-style="expand-right">Ajouter Prescription</button>
