...
<body>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <div class="text-right">
                                            ...
                                            <p class="text-muted mb-1 text-truncate">Actifs de la société</p>
                                        </div>
                                    </div>
                                </div> <!-- end row-->
                            </div> <!-- end widget-rounded-circle-->
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <div class="text-right">
                                            ...
                                            <p class="text-muted mb-1 text-truncate">Médicaments</p>
                                        </div>
                                    </div>
                                </div> <!-- end row-->
                            </div> <!-- end widget-rounded-circle-->
                                ...
                                <div class="widget-rounded-circle card-box">
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <div class="text-right">
                                                <h3 class="text-dark mt-1"></span></h3>
                                                <p class="text-muted mb-1 text-truncate">Ma paie</p>
                                            </div>
                                        </div>
                                    </div> <!-- end row-->
                                </div>
                                        ...
                                        ?>
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="his_doc_view_single_patient.php?pat_id=<?php echo $row->pat_id; ?>&&pat_number=<?php echo $row->pat_number; ?>&&pat_name=<?php echo $row->pat_fname; ?>_<?php echo $row->pat_lname; ?>" class="btn btn-xs btn-success"><i class="mdi mdi-eye"></i> Voir</a>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        <?php } ?>
    ...
    <div class="right-bar">
        <div class="rightbar-title">
            ...
            <h5 class="m-0 text-white">Paramètre</h5>
        </div>
