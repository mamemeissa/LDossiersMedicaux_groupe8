                ...
                <div class="col-md-8 col-lg-6 col-xl-5">
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="text-center w-75 m-auto">
                                <a href="his_admin_logout.php">
                                    <span><img src="assets/images/log.png" alt="" height="60"></span>
                                </a>
                            </div>
                            ...
                            <div class="text-center">
                                ...
                                <h3>On se revoit plus tard !</h3>

                                <p class="text-muted font-13"> Vous êtes déconnecté. </p>
                            </div>
                    ...
                    <div class="row mt-3">
                        <div class="col-12 text-center">
                            <p class="text-white-50">Retour à <a href="index.php" class="text-white ml-1"><b>Log In</b></a> Ou <a href="../../index.php" class="text-white ml-1"><b>Accueil</b></a></p>
                        </div> <!-- end col -->
                    </div>
                    <!-- end row -->
